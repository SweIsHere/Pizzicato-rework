...
def lambda_handler(event, context):
    ...
    artist_id = body['artist_id']  # Ahora accedemos al artist_id dentro de body
    ...
    response = table_users.get_item(Key={'artist_id': artist_id})
    ...
    token_record = {
        'artist_id': artist_id,       # Clave de partición
